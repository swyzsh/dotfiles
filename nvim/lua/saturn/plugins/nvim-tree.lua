return {
  ...
  config = function()
    ...
    local function my_on_attach(bufnr)
      ...
      vim.keymap.del("n", "<C-t>", { buffer = bufnr }) -- Open: New Tab
      vim.keymap.del("n", "g?", { buffer = bufnr }) -- Help
      vim.keymap.del("n", "o", { buffer = bufnr }) -- Open
    ...
    vim.keymap.set(
      ...
      { desc = "File explorer (dir of current file)" }
    )
    vim.keymap.set("n", "<leader>E", "<cmd>NvimTreeToggle<CR>", { desc = "File explorer (cwd)" })
  end,
}
